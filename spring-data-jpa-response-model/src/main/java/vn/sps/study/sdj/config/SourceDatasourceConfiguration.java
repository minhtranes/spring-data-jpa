...
public class SourceDatasourceConfiguration {
    ...
    DataSourceProperties srcDataSourceProperties() {
        return new DataSourceProperties();
    }

    @Bean
    @Primary
    DataSource srcProcessEventDataSource() {
        return srcDataSourceProperties().initializeDataSourceBuilder().build();
    }
    ...
    LocalContainerEntityManagerFactoryBean sourceEntityManagerFactory(
        ...
        return builder.dataSource(srcProcessEventDataSource())
            .persistenceUnit("src").packages(SrcProcessEventEntity.class)
            .build();
    }
